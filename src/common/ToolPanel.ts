...
export class ToolPanel<V> {
  ...
  private _getHtmlForWebview(webview: vscode.Webview) {
    ...
    return `<!DOCTYPE html>
  			...
  			<head>
  				<meta charset="UTF-8">
  				<meta http-equiv="Content-Security-Policy" content="default-src 'none'; worker-src blob:; style-src ${webview.cspSource} 'self' 'unsafe-inline'; img-src ${webview.cspSource} https: blob: data:; script-src 'nonce-${nonce}' 'unsafe-eval';">
